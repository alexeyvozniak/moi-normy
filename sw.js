const CACHE='pravilo-polish-v25';
const ASSETS=['./','./index.html','./polish.css','./mobile-book-fix.css','./onboarding.css','./onboarding.js','./features.css','./features.js','./reading-mode-fix.js','./enhancements.css','./enhancements.js','./practice.css','./practice.js','./practice-types.js','./prayer-haptics.css','./prayer-haptics.js','./meditation-topic-fix.js','./meditation-audio.js','./offline-storage.js','./reminders.css','./reminders.js','./settings-hub.css','./settings-hub.js','./quiet-ui.css','./quiet-ui.js','./install-helper.css','./install-helper.js','./welcome-preview.html','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png','./images/hero.webp','./images/prayer_person_beads.webp','./images/reading_person_book.webp','./images/contemplation_looking_up.webp','./images/samurai_training.webp','./images/selfcare_onsen.webp','./images/calligraphy_ink.webp','./images/walking_path.webp','./images/books_notes.webp','./images/open_book.webp','./images/enso.webp','./images/stat_active.webp','./images/stat_debt.webp','./images/stat_done.webp','./images/onboarding_hero.webp','./images/onboarding_prayer.webp','./images/onboarding_reading.webp','./images/onboarding_meditation.webp','./images/prayer_icons.webp','./images/prayer_prostration.webp','./images/prayer_bow.webp','./images/settings-reminders-v2.svg','./images/settings-data-v2.svg','./images/settings-app-v2.svg'];
...
if(!out.includes('polish.css'))out=out.replace('</head>','<link rel="stylesheet" href="polish.css?v=25">\n</head>');
if(!out.includes('mobile-book-fix.css'))out=out.replace('</head>','<link rel="stylesheet" href="mobile-book-fix.css?v=2">\n</head>');
...
if(!out.includes('prayer-haptics.css'))out=out.replace('</head>','<link rel="stylesheet" href="prayer-haptics.css?v=2">\n</head>');
if(!out.includes('reminders.css'))out=out.replace('</head>','<link rel="stylesheet" href="reminders.css?v=1">\n</head>');
if(!out.includes('settings-hub.css'))out=out.replace('</head>','<link rel="stylesheet" href="settings-hub.css?v=5">\n</head>');
...
if(!out.includes('practice-types.js'))out=out.replace('</body>','<script src="practice-types.js?v=1" defer></script>\n</body>');
if(!out.includes('prayer-haptics.js'))out=out.replace('</body>','<script src="prayer-haptics.js?v=4" defer></script>\n</body>');
if(!out.includes('meditation-topic-fix.js'))out=out.replace('</body>','<script src="meditation-topic-fix.js?v=1" defer></script>\n</body>');
...
if(!out.includes('settings-hub.js'))out=out.replace('</body>','<script src="settings-hub.js?v=5" defer></script>\n</body>');return out;}
