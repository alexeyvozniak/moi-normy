...
function enhancedHtml(text){
  let out=text;
  if(!out.includes('polish.css')) out=out.replace('</head>','<link rel="stylesheet" href="polish.css?v=16">\n</head>');
