const CACHE='pravilo-polish-v19';
...
function enhancedHtml(text){
  let out=text;
  if(!out.includes('polish.css')) out=out.replace('</head>','<link rel="stylesheet" href="polish.css?v=19">\n</head>');
  ...
  if(!out.includes('settings-hub.css')) out=out.replace('</head>','<link rel="stylesheet" href="settings-hub.css?v=2">\n</head>');
