const APP_VERSION='35.7.0';
const CACHE=`pravilo-shell-v${APP_VERSION}`;
const CORE=[
  './','./index.html','./app.css','./app-core.js','./app-bootstrap.js','./manifest.webmanifest',
  './designer-fonts.css','./ui-controls.css','./ui-dialog.css','./responsive.css','./dashboard.css','./editor-layout.css','./onboarding.css','./feature-ui.css','./share-text.css','./mode-tools.css','./practice.css','./prayer-haptics.css','./reminders.css','./settings-hub.css','./quiet-ui.css','./install-helper.css',
