const CACHE='pravilo-polish-v12';
...
function enhancedHtml(text){
  let out=text;
  if(!out.includes('polish.css')) out=out.replace('</head>','<link rel="stylesheet" href="polish.css?v=12">\n</head>');
  ...
  if(!out.includes('quiet-ui.css')) out=out.replace('</head>','<link rel="stylesheet" href="quiet-ui.css?v=1">\n</head>');
